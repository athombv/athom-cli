...
const REQUIRED_NODE_VERSION = '10.10.0';

class App {

	constructor( appPath ) {

	  // Check if user runs required node version or higher
	  if(!semver.gte(process.version, REQUIRED_NODE_VERSION)) {
	    throw new Error(`Error: this command requires node version 10.10.0 or higher`);
    }
