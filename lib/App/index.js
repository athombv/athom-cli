	...
	async createDiscovery() {
		...
		switch( discoveryBase.type ) {
			...
			case 'ssdp':
				...
				break;
			case 'mac':
				console.log('dit is mac address shizzle');
				...
				discoveryJson = {
					...
					"mac": {
						manufacturer: [
							parseMacToDecArray( answers.mac )
							// todo for each ding voor meerdere mac adressen
						]
					}
				}
